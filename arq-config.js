...
(function(){
  ...
  window.ARQSELECT_CONFIG=Object.freeze({
    ...
    systemName:"ARQSELECT",siteUrl:"https://arqselect.com.br/",mediaBaseUrl:"",build:"2026.09.20.600-ECOSYSTEM-OS",
...
(function(){
  ...
  function ensureAssets(){
    ...
    if(!document.querySelector('script[src*="arq-performance.js"]')){const perf=document.createElement('script');perf.src='arq-performance.js?v=6.0.0';perf.defer=true;perf.dataset.arqPerformance='1';head.append(perf);}if(!document.querySelector('script[src*="arq-ecosystem-6.js"]')){const eco=document.createElement('script');eco.src='arq-ecosystem-6.js?v=6.0.0';eco.defer=true;eco.dataset.arqEcosystem='1';head.append(eco);}
  }
  ensureAssets();
})();
