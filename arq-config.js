/* ARQSELECT 5.8.1 — central configuration + theme runtime + harmony loader. */
(function(){
  "use strict";
  ...
  window.ARQSELECT_CONFIG=Object.freeze({
    version:"5.8.1",SYSTEM_NAME:"ARQSELECT",VERSION:"5.8.1",API_URL:active,WHATSAPP:"5519981655013",SITE_URL:"https://arqselect.com.br/",
    systemName:"ARQSELECT",siteUrl:"https://arqselect.com.br/",mediaBaseUrl:"",build:"2026.09.19.581-SERVICE-PROVIDERS-STABILITY",
...
(function(){
  ...
  function load(){
    if(!document.querySelector('link[data-arq6]')){const l=document.createElement('link');l.rel='stylesheet';l.href='arqselect-6.css?v=5.8.1';l.dataset.arq6='1';document.head.append(l);}
    if(!document.querySelector('script[data-arq6]')){const s=document.createElement('script');s.src='arqselect-6.js?v=5.8.1';s.defer=true;s.dataset.arq6='1';document.head.append(s);}
  }
...
(function(){
  ...
  function ensureAssets(){
    ...
    if(!design){design=document.createElement('link');design.id='arq-design-system';design.rel='stylesheet';design.href='arq-design-system.css?v=5.8.1';head.append(design);}
    else{if(!design.id)design.id='arq-design-system';design.href='arq-design-system.css?v=5.8.1';}
    if(!document.querySelector('script[src*="arq-experience.js"]')){const experience=document.createElement('script');experience.src='arq-experience.js?v=5.8.1';experience.defer=true;experience.dataset.arqExperience='1';head.append(experience);}
  }
  ensureAssets();
})();