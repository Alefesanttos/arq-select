...
const STATIC=[
  ...
  './ARQSELECT_LOGIN_PRESTADOR.html','./arq-admin-quality.js','./admin-qualidade.html','./arq-account.js','./arq-resilience.js','./arq-project-hub.js','./arq-rfq.js','./solicitar-orcamento.html','./arq-opportunities.js','./central-oportunidades.html','./sala-projeto.html','./arq-network.js','./conexoes.html','./arq-onboarding.js','./onboarding-arquiteto.html','./onboarding-fornecedor.html','./arq-profile-6.js','./arq-notifications.js','./notificacoes.html','./arq-agenda.js','./agenda.html','./arq-catalog-import.js','./importar-catalogo.html','./arq-exports.js','./exportacoes.html','./arq-moderation.js','./admin-moderacao.html','./404.html','./403.html','./500.html','./icon-192.png','./icon-512.png',
