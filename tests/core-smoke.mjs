...
if(!version.includes('6.1.0'))fail.push('VERSION.txt não está em 6.1.0');
...
if(!cfg.includes('6.1.0'))fail.push('Configuração não está em 6.1.0');
...
console.log('ARQSELECT 6.1 operational core smoke: OK');